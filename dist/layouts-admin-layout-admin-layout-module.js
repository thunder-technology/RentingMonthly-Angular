...
var HouseInfoService = /** @class */ (function () {
    function HouseInfoService(http) {
        this.http = http;
        this.url = 'http://rentingmonthlyserver-env.siexzuwthp.us-east-1.elasticbeanstalk.com/houses';
    }
    HouseInfoService.prototype.getInfo = function () {
        return this.http.get(this.url);
    };
    HouseInfoService.prototype.getHouseInfoById = function (id) {
        return this.http.get(this.url + '/' + id);
    };
    HouseInfoService.prototype.deleteHouseInfoById = function (id) {
...
var HouseRecordingComponent = /** @class */ (function () {
    ...
    HouseRecordingComponent.prototype.onSubmit = function () {
        this.service.postHouseInfoRes(this.form.value).subscribe(function (data) {
...
var HouseRecordingService = /** @class */ (function () {
    ...
    HouseRecordingService.prototype.getHouseInfo = function () {
        return this.http.get(this.url);
    };
    HouseRecordingService.prototype.postHouseInfo = function (body) {
        return this.http.post(this.url, body);
    };
    HouseRecordingService.prototype.postHouseInfoRes = function (body) {
        return this.http.post(this.url, body, {
            observe: 'response',
            responseType: 'json'
        });
...
/*!*********************************!*\
  !*** ./src/app/models/house.ts ***!
  \*********************************/
/*! exports provided: Houses, HouseInfo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Houses = /** @class */ (function () {
    function Houses(address, city, desc, houseType, intersection, postCode, province, totalRooms, latitude, longitude) {
