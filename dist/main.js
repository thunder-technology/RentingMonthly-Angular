...
module.exports = "<div class=\"main-content\">\n    <div class=\"container-fluid\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <div class=\"card\">\n                    <div class=\"card-header card-header-danger\">\n                        <h4 class=\"card-title\">房东列表</h4>\n                        <button mat-raised-button color=\"warn\" (click)=\"openDialog()\">添加数据</button>\n                    </div>\n                    <div class=\"card-body\">\n                        <div class=\"table-responsive\">\n                            <table class=\"table\">\n                                <thead class=\"text-primary\">\n                                    <tr>\n                                        <th *ngFor=\"let header of headers\">\n                                            {{header}}\n                                        </th>\n                                    </tr>\n                                </thead>\n                                <tbody>\n                                    <tr *ngFor=\"let info of userInfo\">\n                                        <th>{{info.userId}}</th>\n                                        <th>{{info.fullName}}</th>\n                                        <th>{{info.userName}}</th>\n                                        <th>{{info.email}}</th>\n                                        <th>{{info.contactNumber}}</th>\n                                        <div>\n                                            <button mat-raised-button color=\"warn\" (click)=\"updateDialog(info)\">修改数据</button>\n                                            <button mat-raised-button color=\"warn\" (click)=\"deleteInfo(info.userId)\">删除数据</button>\n                                        </div>\n                                    </tr>\n                                </tbody>\n                            </table>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n\n"
...
var LandlordInfoService = /** @class */ (function () {
    function LandlordInfoService(http) {
        this.http = http;
        this.url = 'http://rentingmonthlyserver-env.siexzuwthp.us-east-1.elasticbeanstalk.com/users';
    }
    ...
    LandlordInfoService.prototype.postUserInfo = function (body) {
...
var LandlordTableComponent = /** @class */ (function () {
    ...
    LandlordTableComponent.prototype.openDialog = function () {
        this.dialog.open(DialogOverviewExampleDialogComponent, {
            ...
            width: '30em',
            minWidth: '30em',
            data: _models_user__WEBPACK_IMPORTED_MODULE_2__["UserInfo"]
        });
    };
    LandlordTableComponent.prototype.updateDialog = function (userinfo) {
        this.dialog.open(DialogOverviewExampleDialogComponent, {
            disableClose: true,
            hasBackdrop: true,
            width: '30em',
    ...
    LandlordTableComponent.prototype.ngOnInit = function () {
        ...
        this.service.getInfo()
            .subscribe(function (data) { return _this.userInfo = data._embedded.userInfoes; });
    };
...
var DialogOverviewExampleDialogComponent = /** @class */ (function () {
    ...
    DialogOverviewExampleDialogComponent.prototype.onCreate = function () {
        this.service.postUserInfo(this.form.value).subscribe(function (data) {
            console.log('post: \n' + data);
        });
    };
    DialogOverviewExampleDialogComponent.prototype.onUpdate = function () {
        var constData = this.form.value;
        constData.userId = this.data.userId;
        this.service.updateUserInfo(constData).subscribe(function (data) {
            alert('update ' + data);
        });
    };
    DialogOverviewExampleDialogComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"],
            ...
            _models_user__WEBPACK_IMPORTED_MODULE_2__["UserInfo"]])
...
var ConfirmDialogComponent = /** @class */ (function () {
    ...
    ConfirmDialogComponent.prototype.onDelete = function () {
        this.service.deleteUserInfoById(this.id).subscribe(function (data) {
        });
    };
...
/*!********************************!*\
  !*** ./src/app/models/user.ts ***!
  \********************************/
/*! exports provided: UserInfo, Embedded, Links, Page, Info */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
